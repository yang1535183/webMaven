...
import com.yang.model.UserPojo;
...
public class UserController {  
 ...
 // /user/{id}
    ...
    public @ResponseBody UserInfo getUserInJson(@PathVariable String id,Map<String, Object> model){  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        UserInfo user = this.userService.getUserById(userId);  
    ...
    public ResponseEntity<UserInfo>  getUserInJson2(@PathVariable String id,Map<String, Object> model){  
        int userId = Integer.parseInt(id);  
        System.out.println("userId:"+userId);
        UserInfo user = this.userService.getUserById(userId);  
        log.info(user.toString());
